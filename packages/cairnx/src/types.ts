...
// deploy runway. At authoring, ~6,900 blocks above the live tip (~53.1k), so ALL then-current chain data + every
// then-pinned replay vector (max 45,959 at the time; the pin set now extends past 60,000, see B8-hash) was below
// the gate and byte-identical. CROSSED 2026-07-23. V28 test vectors are generated RELATIVE
