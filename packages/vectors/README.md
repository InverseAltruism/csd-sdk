...
Golden conformance vectors for Compute Substrate, the contract every @inversealtruism/csd-* implementation must match (frozen Rust fixtures + captured live blocks).
...
```
npm i @inversealtruism/csd-vectors
```
